...
public class Withdrawal extends JFrame implements ActionListener{
    ...
    JButton withdrawalButton, backButton;
...
//                    String sql="";
                    ...
                    int n=stmt.executeUpdate("INSERT INTO bank VALUES('"+pinNumber+"','"+date+"','Withdraw', '"+amountQuantity+"')");
                    if(n>0){
                        JOptionPane.showMessageDialog(null, "Rs. "+amountQuantity+" Withdrawed Sucessfully");
                        setVisible(false);
